...
steps = 5000
eval_interval = 500
learning_rate = 3e-4 # the self attention can't tolerate very very high learning rates
...
def load_dataset():
    ...
    if not os.path.isfile(filename):
        ...
        data = urlopen('https://raw.githubusercontent.com/karpathy/char-rnn/master/data/tinyshakespeare/input.txt').read()
...
print(f'model has {sum(p.numel() for p in model.parameters())/1e6} parameters')
